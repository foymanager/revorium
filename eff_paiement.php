    ...
    <section class="w3l-contact-1 py-5" id="contact">
            ...
            <div class="container">
                <div class="contactct-fm map-content-9">
                    <div class="header-title text-center">
                        <h3 class="title-w3l mb-2">Paiement de module
                        </h3>
                        <p class="mb-sm-5 mb-4">Effectuez le paiement</p>
                    </div>
                          <form action="paiement.php" class="pt-lg-4" method="post">
                       
                        <div class="twice-two">
                            
                            
                            <select name="niveau" class="form-control" id="w3lPhone" onChange="MM_jumpMenu('parent',this,0)">
     <option value="6">Module 6</option>
                  ...
                  <div class="text-lg-center">
                            <button type="submit" class="btn btn-primary btn-style mt-lg-5 mt-4">je paie </button>
                        </div>
                    </form>
